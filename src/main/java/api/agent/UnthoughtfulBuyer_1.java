 ...
 */
public class UnthoughtfulBuyer_1 implements ActionController {
    ...
    public Card buyCardHook(List<Card> buyOptions) {
        ...
        List<Card> orderedByPrice = buyOptions.stream().sorted(Comparator.comparingInt(Card::getCost).reversed()).toList();
